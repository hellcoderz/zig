...
pub fn OutStream(
    ...
    return struct {
        ...
        pub fn print(self: *const Self, comptime format: []const u8, args: var) Error!void {
        ...
        /// TODO audit non-power-of-two int sizes
        pub fn writeInt(self: *const Self, comptime T: type, value: T, endian: builtin.Endian) Error!void {
            var bytes: [(T.bit_count + 7) / 8]u8 = undefined;
